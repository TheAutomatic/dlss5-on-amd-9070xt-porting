# Install / remove a 0.29 OptiScaler package in Cyberpunk 2077 (bin\x64).
...
if (-not (Test-Path "$game\Cyberpunk2077.exe")) { throw "game exe not found in $game" }
if (Get-Process Cyberpunk2077 -ErrorAction SilentlyContinue) { throw 'Cyberpunk2077.exe is running; close the game first' }
